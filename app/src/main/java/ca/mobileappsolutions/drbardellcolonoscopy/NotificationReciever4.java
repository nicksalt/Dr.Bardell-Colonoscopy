...
public class NotificationReciever4 extends BroadcastReceiver {
    String notText;
    @Override
    ...
    public void genNot(Context context){
        ...
        notText = "In one hour, take three Dulcolax tablets, two if you weigh less than " +
                        "140 lbs.";
        ...
        PendingIntent resultPendingIntent = PendingIntent.getActivity(context, 11,
                resultIntent,
        ...
        mNotifyMgr.notify(4, mBuilder.build());
    }
}
